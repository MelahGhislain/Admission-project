    ...
    <div className=" flex justify-between px-8 py-4 items-center">
        ...
        <nav className="flex space-x-4 items-center">
            <ul className='flex space-x-2 items-center'>
                <li className='transition-all duration-300 hover:bg-green-600/70 px-2 py-1 cursor-pointer hover:text-white'>Home</li>
            ...
            <button className="text-sm bg-green-600/70 px-3 py-1 rounded text-white" onClick={onClick}>Admission</button>
        </nav>
    </div>
  )
}
